// lib/features/ui/pages/mushaf/widgets/page_rich_block.dart
...
class _PageRichBlockState extends State<PageRichBlock> {
  ...
  late final AyahSpanBu ilder _builder;
  ...
  Widget build(BuildContext context) {
    ...
    final localCurrentIndex = widget.currentAyahIndex == null
        ? null
        : _mapToLocal(widget.currentAyahIndex!, widget.range.start, widget.range.end);
