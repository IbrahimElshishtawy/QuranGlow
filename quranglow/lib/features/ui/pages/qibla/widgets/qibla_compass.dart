...
class _CompassDial extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return Transform.rotate(
      angle: -rotationDeg * math.pi / 180, // سالب لأننا ندوّر القرص عكس اتجاه الهاتف
      child: Container(
        decoration: BoxDecoration(
          color: cs.surface,
          shape: BoxShape.circle,
  ...
  Widget build(BuildContext context) {
    return Transform.rotate(
      ...
      child: Column(
        ...
        children: [
          Icon(Icons.navigation, size: 56, color: color),
        ],
      ),
    );
  }
